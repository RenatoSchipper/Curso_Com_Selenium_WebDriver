...
//		driver.quit();
	...
	public void testTextFieldDuplo(){
		dsl.escrever("elementosForm:nome", "Renato");
		Assert.assertEquals("Renato", dsl.obterValorCampo("elementosForm:nome"));
		dsl.escrever("elementosForm:nome", "Schipper");
		Assert.assertEquals("Schipper", dsl.obterValorCampo("elementosForm:nome"));
	}
